...
const AddGoal: React.FC<AddTransactionProps> = ({ categories, userID }) => {
    ...
    return (
        <div className="container">
            <IonFab vertical="bottom" horizontal="end" slot="fixed">
                <IonFabButton id="add-goal" onClick={() => { openForm(); modalStartRef.current?.present(); }}>
                    <IonIcon icon={add} />
                </IonFabButton>
            </IonFab>
            ...
            <IonModal id="add-goal-modal" ref={modalStartRef}>
                <IonHeader>
                    <IonToolbar>
                        <IonTitle className="ion-text-center">New Goal</IonTitle>
                    </IonToolbar>
                </IonHeader>
            ...
            <IonModal id="add-goal-modal" ref={modalSubmitRef}>
                ...
                <IonContent>
                    <div className="ion-padding-start ion-padding-end ion-margin-bottom ion-margin-top">
                        ...
                        {reminder && (
                            <IonItem>
                                <IonLabel>Reminder Date: </IonLabel>
                                <IonDatetimeButton
                                    className="ion-margin"
