...
import { exportUserDataJSON } from "../utilities/DataExport"; // Import the export function
...
const LandingPage: React.FC = () => {
    ...
    const handleExportJSON = () => {
        if (user) {
            // Assuming you have a way to get user categories
            const categories = []; // Replace with actual categories fetching logic
    ...
    return (
        <React.Fragment>
            ...
            <IonPage id="main-content">
                ...
                <IonContent>
                    {!user ? (
                        <LoginPage setUser ={setUser } setErrorMessage={(msg) => console.error(msg)} />
                    ) : (
