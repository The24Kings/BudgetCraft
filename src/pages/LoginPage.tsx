...
const LoginPage: React.FC<{ setUser:  (user: any) => void; setErrorMessage: (msg: string) => void; }> = ({ setUser , setErrorMessage }) => {
    ...
    const handleRegister = async () => {
        try {
            ...
            const settingsRef = doc(collection(firestore, `users/${user.uid}/settings`), "categories");
    ...
    const handleSignIn = async () => {
        try {
            ...
            setErrorMessageLocal(""); // Clear error message
            ...
            setErrorMessageLocal(error.message); // Set error message
        }
    };
    ...
    return (
        <div className="login-container">
            ...
            {errorMessage && <IonText className="error-message">{errorMessage}</IonText>} {/* Display error message */}
            {isRegistering && (
                <>
                    <IonItem>
